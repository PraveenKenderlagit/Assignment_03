...
plot (PBmonthly$year,PBmonthly$October, xlab = "Year", ylab = "Apprehensions", type = "p", main = "Apprehensions By Year")
lines(PBmonthly$year,PBmonthly$October, col = "red")
points(PBmonthly$year,PBmonthly$October, col = "red")
